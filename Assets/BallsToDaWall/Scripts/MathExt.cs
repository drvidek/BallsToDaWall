...
public class MathExt
{
    ...
    /// <summary>
    /// Clip the values of Vector3 vector to d decimal places
    /// </summary>
    /// <param name="vector"></param>
    /// <param name="d"></param>
    /// <returns></returns>
    public static Vector3 ClipToDecimalPlace(Vector3 vector, float d)
    {
        float precision = Mathf.Max(1, Mathf.Pow(10, d));
        return new Vector3(Mathf.Ceil(vector.x * precision) / precision, Mathf.Ceil(vector.y * precision) / precision, Mathf.Ceil(vector.z * precision) / precision);
    }
