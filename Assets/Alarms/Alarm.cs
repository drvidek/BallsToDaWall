...
public class Alarm
{
    ...
    /// <summary>
    /// Runs the alarm for one frame (will not affect a fixed alarm).
    /// </summary>
    public void Run()
    {
        if (_type == Type.@fixed)
    ...
    /// <summary>
    /// Runs the alarm for one fixed update length (will not affect scaled and unscaled alarms).
    /// </summary>
    ...
    /// <summary>
    /// Play the alarm from its current time (the alarm at 0sec will loop/release but will not trigger the Complete event).
    /// </summary>
    public void Play()
    {
        _paused = false;
    ...
    /// <summary>
    /// Reset the alarm to maximum value (does not restart a paused/stopped alarm).
    /// </summary>
    public void Reset()
    {
    ...
    /// <summary>
    /// Reset the alarm and its maximum to t (does not restart a paused/stopped alarm).
    /// </summary>
    ...
    /// <summary>
    /// Release the alarm, effectively removing it from use. Auto-releasing alarms will do this automatically on Complete, unless looping or set from the inspector.
    /// </summary>
    public void Release()
    {
